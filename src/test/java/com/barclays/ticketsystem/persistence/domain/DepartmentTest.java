...
class DepartmentTest {
	...
	void testGettersAndSetter() {
		Ticket testTicket1 = new Ticket(1L, "Title", "String", "Author");
		Ticket testTicket2 = new Ticket(2L, "Title2", "String2", "Author2");
		Ticket testTicket3 = new Ticket(3L, "Title3", "String3", "Author3");
